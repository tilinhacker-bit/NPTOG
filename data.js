...
const DATA = {
    ...
    // 4. PUBLIC DIRECTORY (Seniors & HO Groups)
    directory: [
        {
        ...
        },
        {
            ...
            contacts: [
                { name: "Group 1", phone: "Dr. Han Myint Mo Mo, Dr. Nang Sanda Htun" },
                { name: "Group 2", phone: "Dr. May Thu Khaing, Dr. Hlaing Myo Oo" },
                { name: "Group 3", phone: "Dr. Thukha Wynn, Dr. Nay Linn Oo" }
            ]
        },
        {
            category: "House Surgeon Groups (HO)",
            contacts: [
                { name: "Grp A: HS. Myat Min Khant", phone: "09-440076868" },
                { name: "Grp A: HS. Phoo Pyae Pyae Hlaing", phone: "09-978144352" },
                { name: "Grp A: HS. Phu Myat Thwe", phone: "09-970743532" },
                { name: "Grp B: HS. Myo Min Kyaw", phone: "09-261463976" },
                { name: "Grp B: HS. Myat Mon Mon Kyaw", phone: "09-2130724" },
                { name: "Grp B: HS. May Thet Paing Kyaw", phone: "09-424943829" },
                { name: "Grp C: HS. Aung Kaung Thant Kyaw", phone: "09-660160164" },
                { name: "Grp C: HS. Dazen Kyaw", phone: "09-780920988" },
                { name: "Grp C: HS. Hsu Mon Kyaw", phone: "09-445144704" },
                { name: "Grp D: HS. Kaung Myat Htal", phone: "09-420707474" },
                { name: "Grp D: HS. Mon Mon Thant", phone: "09-789686980" },
                { name: "Grp D: HS. Mon Mon Theint Kyaw", phone: "09-452887045" }
            ]
        }
    ]
};
